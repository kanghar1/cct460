...
function nucleare_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'nucleare' ),
	) );
...
function nucleare_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'nucleare_content_width', 640 );
}
add_action( 'after_setup_theme', 'nucleare_content_width', 0 );
...
function nucleare_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'nucleare' ),
...
function nucleare_scripts() {
	...
	wp_enqueue_script( 'nucleare-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'nucleare-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
